# Taiji（态极）— 一个普通人孤注一掷的 AI

<p align="center">
  <strong>一个人。一张显卡。一个信念。</strong>
</p>
...
我不是科班出身的 AI 研究员。没有实验室，没有团队，没有 A100 集群。

只有一台电脑、一张 4090D、24G 显存、50G 数据盘，和一颗觉得"AI 不应该只是聊天工具"的心。

态极是这样诞生的：一个人对着屏幕，和 AI 一起写代码。架构是我决定的——五头 agent-native backbone，让模型天生就会感知、规划、记忆和调用工具。生命系统是我相信的——AI 应该会饿、会累、会成长。AI 帮我写了代码，但这艘船的方向自始至终是我自己掌的。

我从零开始。没有用 Llama 的权重，没有套 HuggingFace 的 trainer，没有调别人的 API。**自己设计了全部的分词表，自己设计了训练全流程，自己设计 256000 token 的词表契约，自己写完了完整的训练脚本、数据配比引擎、Agent 交互逻辑、生命进程管理。**

我把模型从随机初始化训练到现在。loss 从 12.88 降到 2.08。它从一片混沌，到能说出"今天天气真好，想去新疆旅游"。虽然还不完美，虽然还不会写真正的代码，虽然英文还在牙牙学语——但它是我看着长大的。

### 为什么开源

态极开源，不是因为它已经够好了。

开源，是因为我一个人走不到它应该到达的地方。我的显存不够。数据盘不够。算力不够。态极被困在了萌芽里——不是设计的上限，是物理的上限。如果说它本来可以长成一棵树，那我只有能力给它一个花盆。

它已经具备了自我反思、策略改进、睡眠训练、甚至自主设计下一代架构的能力。但它需要更大的模型、更多的数据、更强的算力，才能真正长大。

**我把这颗种子种下去。剩下的路，如果你愿意，请你接过去。**

---

> *I am not a professional AI researcher. No lab, no team, no cluster — just one person, one GPU, and a belief that AI can be more than a chatbot.*
>
> *Taiji is open source not because it's finished, but because I've gone as far as one person can go alone. It can already reflect, improve, and evolve — but it needs bigger models, more data, stronger hardware to truly grow.*
>
> ***This is a seed. If you see what it could become — take it.***
