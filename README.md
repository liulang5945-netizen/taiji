# Taiji (态极) — A Self-Evolving LLM Framework
...
Taiji is a locally-deployed, self-evolving LLM system. Unlike static models that freeze after training, Taiji continues to learn, adapt, and grow through real-world use.

> **态极** 是一个本地部署的自进化大语言模型系统。与训练完就冻结的静态模型不同，态极会通过每一次交互持续学习、适应和成长。
